...
namespace MMB
{
    ...
    public partial class MarkingMessageBox : Window, INotifyPropertyChanged
    {
        ...
        {
            get { return _btnOK; }
            set { _btnOK = value; FirePropertyChanged(() => BtnOK); }
        }
        ...
        public string BtnCancel
        {
            ...
            set { _btnCancel = value; FirePropertyChanged(() => BtnCancel); }
        }
        ...
        /// <returns></returns>
        public bool Invoke(string message, string caption, Window owner = null, string btnOK = "确定", string btnCancel = "取消")
        {
            // 设置父窗口
            Owner = owner;
            ...
            if (Owner != null)
            {
                ...
                // 开启淡入效果
                marking.BeginAnimation(Border.OpacityProperty, new DoubleAnimation(0.5, new Duration(TimeSpan.FromMilliseconds(300))));
